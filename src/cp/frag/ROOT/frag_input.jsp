...
<HR>
        <H3><FONT FACE="Arial" COLOR="#003366">Modifications (optional)</FONT></H3>
                ...
                <TABLE BORDER=0>
                <TR VALIGN=TOP>
                <TD ALIGN=RIGHT><TT><B><FONT FACE="Times New Roman" COLOR="#003366">Add to N- or C-terminus: </FONT></TT></TD>
                <TD></TD>
                <TD WIDTH=150><TT><FONT FACE="Times New Roman" COLOR="#003366">N-terminus</FONT></TT><BR>
                    <INPUT TYPE="TEXT" NAME="nterm" VALUE="0.0" SIZE="5" MAXLENTH="5"> </TD>
                <TD WIDTH=150><TT><FONT FACE="Times New Roman" COLOR="#003366">C-terminus</FONT></TT><BR>
                    <INPUT TYPE="TEXT" NAME="cterm" VALUE="0.0" SIZE="5" MAXLENTH="5"> </TD>
                </TR>
                <TR VALIGN=TOP>

                <TD><PRE><B><FONT FACE="Times new roman" COLOR="#003366"></br>Add to all AA residues and/or specific location: </FONT>
                ...
                <TD></TD>
                <TD><TT><FONT FACE="Times New Roman" COLOR="#003366"></br>AA or Pos &nbsp;</FONT></TT><BR>
                    <TEXTAREA NAME="addModifType" ROWS=3 COLS=3></TEXTAREA></TD>

                <TD><TT><FONT FACE="Times New Roman" COLOR="#003366"></br>Value</FONT></TT><BR>
